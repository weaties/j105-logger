...
async function _loadSails(sessionId, el) {
  ...
  slots.forEach(slot => {
    ...
    html += '<div style="display:flex;align-items:center;gap:6px;margin-bottom:4px">'
      ...
      + '<select id="sail-select-' + slot + '-' + sessionId + '" style="flex:1;background:var(--bg-secondary);color:var(--text-primary);border:1px solid var(--action);border-radius:4px;padding:3px 6px;font-size:.78rem">'
